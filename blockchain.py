...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Aryan', amount = '10')
...
def is_valid():
    ...
    if is_valid:
        response = {'message':'Everything is all right'}
    else:
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'Chain Length mismatch fixed by adopting the longest chain',
                    'new_chain': blockchain.chain}
    else:
        response = {'message': 'Chain Length all good',
